                ...
                <div class="aside-menu flex-column-fluid">
                    <div class="hover-scroll-overlay-y my-5 px-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <div class="menu-item">
                                <a href="#" class="menu-item menu-accordion">
                                    <span class="menu-link {{Request::is('report*') ? 'active' : ''}}">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                            ...
                            <div class="menu-item">
                                <a href="#" class="menu-item menu-accordion">
                                    <span class="menu-link {{Request::is('ticket*') ? 'active' : ''}}">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                                        ...
                                        <span class="menu-title">{{ __('Ticket Management')}}</span>
                                    </span>
                                </a>
                            </div>

                            <div class="menu-item">
                                <a href="{{ url('user') }}" class="menu-item menu-accordion">
                                    <span class="menu-link {{Request::is('user*') ? 'active' : ''}}">
                                        ...
                                        <span class="menu-title">{{ __('Employee Management')}}</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="toolbar d-flex align-items-stretch">
                        <div class="container-fluid py-6 py-lg-0 d-flex  flex-lg-row align-items-lg-stretch justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="aside-toolbar flex-column-auto pt-2" id="kt_aside_toolbar">
